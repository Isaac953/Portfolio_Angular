...
export class ProyectsComponent implements OnInit {
  ...
  proyectsCards: any[] = [
    ...
    {
      coverProyect: './assets/images/sistema_elementos/slide_3.png',
      titleProyect: 'Sistema Elementos',
      year: '2019',
      slides: [
        {
          proyect: './assets/images/sistema_elementos/slide_1.PNG',
          caption: 'Login de Usuario',
          dot: 1,
          activeDot: 'active-dot',
        },
        {
          proyect: './assets/images/sistema_elementos/slide_2.PNG',
          caption: 'Carga de pantalla',
          dot: 2,
          activeDot: '',
        },
        {
          proyect: './assets/images/sistema_elementos/slide_3.png',
          caption: 'Pantalla principal del sistema',
          dot: 3,
          activeDot: '',
        },
        {
          proyect: './assets/images/sistema_elementos/slide_4.PNG',
          caption: 'Botones de alerta',
          dot: 4,
          activeDot: '',
        },
        {
          proyect: './assets/images/sistema_elementos/slide_5.PNG',
          caption: 'Parametros de configuración',
          dot: 5,
          activeDot: '',
        },
        {
          proyect: './assets/images/sistema_elementos/slide_6.png',
          caption: 'Preguntas frecuentes',
          dot: 6,
          activeDot: '',
        },
        {
          proyect: './assets/images/sistema_elementos/slide_7.PNG',
          caption: 'Manuales integrados en la aplicación',
          dot: 7,
          activeDot: '',
        },
        {
          proyect: './assets/images/sistema_elementos/slide_8.PNG',
          caption: 'Vista de mantenimiento para productos',
          dot: 8,
          activeDot: '',
        },
        {
          proyect: './assets/images/sistema_elementos/slide_9.PNG',
          caption: 'Crear cotización',
          dot: 9,
          activeDot: '',
        },
        {
          proyect: './assets/images/sistema_elementos/slide_10.PNG',
          caption: 'Factura de venta',
          dot: 10,
          activeDot: '',
        },
        {
          proyect: './assets/images/sistema_elementos/slide_11.PNG',
          caption: 'Vista para impresión de facturas',
          dot: 11,
          activeDot: '',
        },
      ],
      skills: [
        { logoRoute: './assets/icons/net_core_icon.png', name: '.NET', class: 'python' },
        { logoRoute: './assets/icons/csharp_icon.png', name: 'C#', class: 'python' },
        { logoRoute: './assets/icons/mysql_icon.png', name: 'MySQL', class: 'python' },
        { logo: faGithub, name: 'Git/GitHub', class: 'git' },
      ],
      urlProyect: 'https://isaac953.github.io/Portfolio_Angular/home',
      descriptionProyect:
        'Sistema de inventario, cotizaciones y facturación, creado para la empresa Elementos Industriales SV por medio de archivo de instalación en un servidor local, realizado con .NET, C# Windows Forms, MySQL como base de datos y Git para control de versiones.',
    },
